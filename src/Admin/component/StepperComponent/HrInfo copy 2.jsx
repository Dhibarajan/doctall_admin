    ...
    return (
        <div style={{ width: '100%' }} className={classes2.root}>
            <Formik
                ...
                onSubmit={value => {
                    console.log(value)
                    // const { full_name, houseNumber, city, state, postalcode, country, email, emgfull_name, emgaddress, emghouseNumber, emgcity, emgstate, emgpostalcode, emgemail, emgphone, dateAdded, li_authority, dateIssue, dateExpiry } = value;
                    // setHrinfo(full_name, houseNumber, city, state, postalcode, country, email, mobile, emgfull_name, emgaddress, emghouseNumber, emgcity, emgstate, emgpostalcode, emgcountry, emgemail, emgphone, professional_indemnity, dateAdded, li_authority, dateIssue, dateExpiry, docStatus)
                }}
                            ...
                            <Grid spacing={3} container>
                                ...
                                <Grid item xs={12}>
                                    ...
                                    <div style={{ display: 'flex' }}>
                                        ...
                                        <div className={classes.primaryLabel} style={{ width: '70%' }}>This confirms that Dr. Samiat Aremu has been added to Doctall Group PI Policy</div>
                                    </div>
                                </Grid>
